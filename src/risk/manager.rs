...
impl RiskManager {
    ...
    pub fn register_order_pair(
        ...
        // 更新风险敞口成本（USD）
        self.position_tracker.update_exposure_cost(yes_token, yes_price, pair.yes_filled);
        self.position_tracker.update_exposure_cost(no_token, no_price, pair.no_filled);
